        ...
        <BasePageTemplate>
            <div className="w-full flex flex-col justify-center items-center">
                <div className="lg:w-container justify-center items-center mb-3 mt-0 lg:mt-16 p-6">
                    ...
                    <div className="mb-10 text-teal-900">
                        <p className="pb-3">
                            Компания &ldquo;Инновации Бизнес Консалтинг&ldquo; была основана профессиональными оценщиками, и именно
                    ...
                    <table className="bg-grayBg hover:bg-orange-600 border border-slate-500 bg-grayBg cursor-text">
                        ...
                        <tr>
                            ...
                            <td className="bg-grayBg hover:bg-white transition-colors duration-300 p-2 border border-slate-200 hover:border-slate-500 border-nepal">ООО &ldquo;Инновации Бизнес Консалтинг&ldquo;, ООО &ldquo;ИБК&ldquo;</td>
                        </tr>
                        <tr>
            ...
            <div className="w-full flex flex-col justify-center items-center bg-white pt-7">
                <div className="lg:w-container p-7 text-teal-900">
                    ...
                    <h3 className="text-lg font-medium mb-3">Оценочная компания &ldquo;Инновации Бизнес Консалтинг&ldquo; оказывает следующие виды услуг:</h3>
                    ...
                    <ul className="list-disc mb-7 ml-12">
                        <li>Федеральный закон № 135-ФЗ &ldquo;Об оценочной деятельности в Российской Федерации&ldquo;</li>
                        <li>ФСО № 1 &ldquo;Общие понятия оценки, подходы к оценке и требования к проведению оценки&ldquo;</li>
                        <li>ФСО №2 &ldquo;Цель оценки и виды стоимости&ldquo;</li>
                        <li>ФСО №3 &ldquo;Требования к отчету об оценке&ldquo;</li>
                        <li>ФСО №4 &ldquo;Определение кадастровой стоимости объектов недвижимости&ldquo;</li>
                        <li>ФСО №5 &ldquo;Виды экспертизы, порядок её проведения, требования к экспертному заключению и порядку его утверждения&ldquo;</li>
                        <li>ФСО №6 &ldquo;Требования к уровню знаний эксперта саморегулируемой организации оценщиков&ldquo;</li>
                        <li>ФСО №7 &ldquo;Оценка недвижимости&ldquo;</li>
                        <li>ФСО №8 &ldquo;Оценка бизнеса&ldquo;</li>
                        <li>ФСО №9 &ldquo;Оценка для целей залога&ldquo;</li>
                        <li>ФСО №10 &ldquo;Оценка стоимости машин и оборудования&ldquo;</li>
                        <li>ФСО №11 &ldquo;Оценка нематериальных активов и интеллектуальной собственности&ldquo;</li>
                    </ul>
